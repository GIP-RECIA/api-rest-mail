...
import fr.recia.widget.api.api.rest.mail.config.bean.AppConfProperties;
import fr.recia.widget.api.api.rest.mail.config.custom.impl.CasSuccessHandler;
import fr.recia.widget.api.api.rest.mail.config.custom.impl.CustomSessionMappingStorage;
import fr.recia.widget.api.api.rest.mail.config.custom.impl.UserCustomImplementation;
import fr.recia.widget.api.api.rest.mail.services.ProxyGrantingTicketRedisImpl;
