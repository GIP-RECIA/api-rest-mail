...
package com.example.demo_redis.config.custom.impl;
...
//        getRedirectStrategy().sendRedirect(request, response, baseUrl + servletContext.getContextPath()+"/test/cas-secured");
